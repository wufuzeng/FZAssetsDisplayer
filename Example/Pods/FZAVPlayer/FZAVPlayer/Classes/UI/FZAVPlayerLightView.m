...
@end
@implementation FZAVPlayerLightView
...
-(void)lightControlTouch:(UIPanGestureRecognizer *)sender{
    ...
    screenBrightNess += [FZAVPlayerLightView getScreenBrightness];
    ...
    //设置屏幕亮度
    [FZAVPlayerLightView setScreenBrightness:screenBrightNess];
    //设置百分比
    [self showPercentValue:[FZAVPlayerLightView getScreenBrightness]];
...
-(UIProgressView *)progressView{
    if (_progressView == nil) {
        ...
        _progressView.progress = [FZAVPlayerLightView getScreenBrightness];
