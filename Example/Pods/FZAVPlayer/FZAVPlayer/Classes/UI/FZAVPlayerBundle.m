...
@implementation FZAVPlayerBundle
...
+ (NSBundle *)fz_bundle{
    ...
    if (bundle == nil) {
        ...
        bundle = [NSBundle bundleWithPath:[currentBundle pathForResource:@"FZAVPlayer" ofType:@"bundle"]];
        if (bundle == nil) {
            //mainBundle
            NSBundle *mainBundle = [NSBundle mainBundle];
            bundle = [NSBundle bundleWithPath:[mainBundle pathForResource:@"FZAVPlayer" ofType:@"bundle"]];
        }
    }
    return bundle;
}
