...
@interface FZAVPlayerTitleBar ()

@end

@implementation FZAVPlayerTitleBar
...
-(UIButton *)backButton{
    if (_backButton == nil) {
        ...
        [_backButton setImage:[FZAVPlayerBundle fz_imageNamed:@"left_back_icon_white_60x60"] forState:UIControlStateNormal];
