...
@implementation FZFilePreviewerBundle
...
+ (NSBundle *)fz_bundle{
    ...
    if (bundle == nil) {
        ...
        bundle = [NSBundle bundleWithPath:[currentBundle pathForResource:@"FZFilePreviewer" ofType:@"bundle"]];
        if (bundle == nil) {
            //mainBundle
            NSBundle *mainBundle = [NSBundle mainBundle];
            bundle = [NSBundle bundleWithPath:[mainBundle pathForResource:@"FZFilePreviewer" ofType:@"bundle"]];
        }
    }
    return bundle;
}
